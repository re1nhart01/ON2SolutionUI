/**
 * @file lv_conf.h
 * LVGL v8 Configuration - Optimized for ESP32-S3
 */
...
/*====================
   DRAWING
 *====================*/
/* КРИТИЧНО: Complex draw включает тени, градиенты и т.д. */
#define LV_DRAW_COMPLEX 0              /* ВЫКЛ для производительности! */
...
/*====================
   GPU (НЕ ПОДДЕРЖИВАЕТСЯ В V8 КАК У ТЕБЯ)
 *====================*/
...
#define LV_USE_THEME_DEFAULT 1
    ...
    #define LV_THEME_DEFAULT_TRANSITION_TIME 0  /* Мгновенно */
#endif
