...
namespace ON2Solutions {
  ...
  class InfoModal final : public Component<InfoModalProps> {
   public:
    ...
    explicit InfoModal(InfoModalProps&& props)
                          ...
                          ViewProps::up()
                              ...
                              .set_children(children(
                                  this->makeRow(locales::en::info_device,
                                                this->props.device),
                                  this->makeRow(locales::en::info_loader,
                                                this->props.loader),
                                  this->makeRow(locales::en::info_fw,
                                                this->props.fw),
                                  this->makeRow(locales::en::info_fw_checksum,
                                                this->props.fw_checksum),
                                  this->makeRow(locales::en::info_module_name,
                                                this->props.module_name),
                                  this->makeRow(locales::en::info_module_fw,
                                                this->props.module_fw),
                                  this->makeRow(locales::en::info_serial_number,
                                                this->props.serial_number),
                                  this->makeRow(locales::en::info_ethernet_ip,
                                                this->props.ethernet_ip),
                                  this->makeRow(locales::en::info_wifi_ip,
                                                this->props.wifi_ip),
                                  this->makeRow(locales::en::info_lcd_fw,
                                                this->props.lcd_fw),
                                  this->makeRow(locales::en::info_lcd_loader,
                                                this->props.lcd_loader),
                                  this->makeRow(locales::en::info_lcd_partition,
                                                this->props.lcd_partition),
