...
#pragma region CALIBRATION_OXYGEN_SHIFT
  ...
  inline constexpr ParamSpec OxygenShiftASpec{
    .label = "Oxy-A",
    .min = -5.0f, .max = 5.0f, .step = 0.1f, .precision = 1,
    .num_sensor = 1,
    .default_value = 0.0f,
...
#pragma region TIMERS
  ...
  inline constexpr ParamSpec CompressorDelaySpec{
    ...
    .precision = 0,
    .default_value = 9.0f,
    .command = SendableCommands::CompressorDelay
  }; // CD
  ...
  inline constexpr ParamSpec RunUpTimeSpec{
    ...
    .command = SendableCommands::RunUpTime
  }; // RU
  ...
  inline constexpr ParamSpec PreStartTimeSpec{
    ...
    .precision = 0,
    .default_value = 30.0f,
    .command = SendableCommands::PreStartTime
  }; // PS
...
#pragma region LIMITS_OXYGEN
  ...
  inline constexpr ParamSpec WorkConcentrationSpec{
    ...
    .precision = 1,
    .default_value = 95.0f,
    .command = SendableCommands::WorkOxygenConcentration
  }; // WC
  ...
  inline constexpr ParamSpec LowLimitConcentrationSpec{
    ...
    .precision = 1,
    .default_value = 80.0f,
    .command = SendableCommands::LowOxygenLimit
  }; // LL
  ...
  inline constexpr ParamSpec LowLimitTimeSpec{
    ...
    .precision = 0,
    .default_value = 10.0f,
    .command = SendableCommands::LowOxygenLimitTime
  }; // LT
...
#pragma region LIMITS_PRESSURE
  ...
  inline constexpr ParamSpec TankHighLimitSpec{
    ...
    .precision = 0,
    .default_value = 50.0f,
    .command = SendableCommands::TankPressureHighLimit
  }; // TH
  ...
  inline constexpr ParamSpec TankLowLimitSpec{
    ...
    .precision = 0,
    .default_value = 40.0f,
    .command = SendableCommands::TankPressureLowLimit
  }; // TL
...
#pragma region LIMITS_SYSTEM
  ...
  inline constexpr ParamSpec ErrorCountSpec{
    ...
    .precision = 0,
    .default_value = 1.0f,
    .command = SendableCommands::ErrorCountToAlarm
  }; // EC
  ...
  inline constexpr ParamSpec TempOverheatSpec{
    ...
    .precision = 0,
    .default_value = 55.0f,
    .command = SendableCommands::OxygenOverheatTempLimit
  }; // TO
  ...
  inline constexpr ParamSpec FlowErrorSpec{
    ...
    .precision = 1,
    .default_value = 1.2f,
    .command = SendableCommands::FlowError
  }; // FE
...
#pragma region SERVICE
  ...
  inline constexpr ParamSpec ValveHighTimeSpec{
    ...
    .precision = 1,
    .default_value = 6.9f,
    .command = SendableCommands::SpvValveOpenTime
  }; // VH
  ...
  inline constexpr ParamSpec ValveLowTimeSpec{
    ...
    .precision = 1,
    .default_value = 4.9f,
    .command = SendableCommands::SpvValveCloseTime
  }; // VL
  ...
  inline constexpr ParamSpec CalibrateValveSpec{
    ...
    .precision = 0,
    .default_value = 0.0f,
    .command = SendableCommands::SpvValveAutoCalibration
  }; // CV

  // PT is enum, not a Stepper
  enum class PressureType : char {
    A = 'A', // analog
    B = 'B', // dry contacts NO
    C = 'C' // dry contacts NC
  };  // PT
