...
namespace ON2Solutions::parser {
  ...
  inline const char* CH_PACKETS[15] = {
    ...
    "HR=323456789:44>",
    "$</CH=5/ST=F/O2=95.7;79.2;20.5;0.0/FL=10.1;9.9;1.2;5.6/TR=11;16/II=T/IO=FFAA/ER=00000000/PS=50;1/"
    "HR=423456789:45>",
  ...
  static const std::vector<const char*> PRESSURE_TYPE_OPTIONS{ "A", "B", "C", "D", "E", "F", "G", "H"  };
